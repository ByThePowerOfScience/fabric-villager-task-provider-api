...
import net.minecraft.entity.ai.brain.task.CompositeTask.Order;
import net.minecraft.entity.ai.brain.task.CompositeTask.RunMode;
...
public class VillagerTaskListProvider {
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createIdleTasks(VillagerProfession profession, float f) {
		final Predicate<? extends PassiveEntity> isReadyToBreed = PassiveEntity::isReadyToBreed;
